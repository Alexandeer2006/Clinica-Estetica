...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4faf54fe-d2d2-11f0-81ea-c03eba0b5a9e:1-87';
...
MODIFY COLUMN id_paciente INT NOT NULL AUTO_INCREMENT;
--
...
INSERT INTO `procedimientos` VALUES (1,'2025-01-10','08:00:00',1.50,'Consulta general',1,31,11),(2,'2025-01-11','09:00:00',2.00,'Examen médico',2,32,12),(3,'2025-01-12','10:00:00',1.00,'Control',3,33,13),(4,'2025-01-13','11:00:00',1.75,'Tratamiento',4,34,14),(5,'2025-01-14','12:00:00',2.50,'Evaluación',5,35,15),(6,'2025-01-15','13:00:00',1.25,'Seguimiento',6,36,16),(7,'2025-01-16','14:00:00',1.00,'Revisión',7,37,17),(8,'2025-01-17','15:00:00',1.80,'Diagnóstico',8,38,18),(9,'2025-01-18','16:00:00',2.20,'Procedimiento',9,39,19),(10,'2025-01-19','17:00:00',1.40,'Consulta final',10,40,20);
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `enfermera_revisa` FOREIGN KEY (`id_e`) REFERENCES `enfermeras` (`id_enfermera`),
...
(1,'Botox',120,NULL,'Inyeccion',50,'2026-12-31','2024-01-10',11),
(2,'Acido Hialuronico',150,'Juvederm','Inyeccion',40,'2026-11-30','2024-02-05',12),
(3,'Anestesia',80,'Medica','Medicamento',100,'2027-05-20','2024-03-01',13),
(4,'Crema Facial',30,'SkinCare','Crema',60,'2025-08-15','2024-01-20',14),
(5,'Guantes',10,'SafeMed','Insumo',500,'2028-01-01','2024-01-01',15),
(6,'Mascarillas',5,'SafeMed','Insumo',800,'2027-06-30','2024-02-10',16),
(7,'Jeringas',2,'Inject','Insumo',1000,'2029-12-31','2024-01-05',17),
(8,'Laser Gel',45,'LaserPro','Gel',70,'2026-09-30','2024-03-15',18),
(9,'Vitamina C',25,'NutriSkin','Suplemento',90,'2026-04-10','2024-02-25',19),
(10,'Peeling',60,'DermaPlus','Quimico',55,'2026-07-07','2024-03-30',20);
